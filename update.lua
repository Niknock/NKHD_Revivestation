...
Citizen.CreateThread( function()
    PerformHttpRequest("https://raw.githubusercontent.com/Niknock/NKHD_Revivestation/main/version", checkVersion, "GET")
end)